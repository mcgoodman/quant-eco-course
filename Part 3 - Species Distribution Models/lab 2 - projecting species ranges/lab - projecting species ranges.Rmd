...
Now, let's fit multiple different models using combinations of your chosen BIOCLIM variables as predictors. In each model, you can have as few as 1 predictor or as many as 6. These will, of course, be Bernoulli GAMs. For example:
...
2.  The final model structure and code
